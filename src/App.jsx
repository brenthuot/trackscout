...
const CITY_COORDS = {
  ...
  "Lincoln, NE":[40.813,-96.702],"Buffalo, NY":[42.887,-78.879],"Orlando, FL":[28.538,-81.380],
  "Madison, WI":[43.073,-89.401],"Durham, NC":[35.994,-78.899],"Lubbock, TX":[33.578,-101.855],
  "Reno, NV":[39.530,-119.814],"Baton Rouge, LA":[30.458,-91.154],"Richmond, VA":[37.541,-77.433],
  "Des Moines, IA":[41.600,-93.609],"Montgomery, AL":[32.361,-86.279],"Akron, OH":[41.081,-81.519],
  ...
  "Norman, OK":[35.222,-97.439],"Provo, UT":[40.234,-111.659],"Jackson, MS":[32.298,-90.184],
  "Fort Collins, CO":[40.585,-105.084],"Sioux Falls, SD":[43.549,-96.700],"Boston, MA":[42.360,-71.058],
  "Portland, OR":[45.523,-122.676],"Memphis, TN":[35.149,-90.048],"Miami, FL":[25.775,-80.209],
  "Detroit, MI":[42.331,-83.046],"Cleveland, OH":[41.499,-81.695],"Fayetteville, AR":[36.062,-94.158],
  "Asheville, NC":[35.574,-82.551],"Iowa City, IA":[41.661,-91.530],"Champaign, IL":[40.116,-88.243],
  "Ann Arbor, MI":[42.281,-83.743],"Tuscaloosa, AL":[33.210,-87.569],"Eugene, OR":[44.052,-123.087],
  ...
  "Amarillo, TX":[35.222,-101.831],"Corpus Christi, TX":[27.800,-97.397],"Tulsa, OK":[36.154,-95.993],
  "Boulder, CO":[40.015,-105.270],"Chestnut Hill, MA":[42.337,-71.168],"New Haven, CT":[41.308,-72.928],
  "Albany, NY":[42.651,-73.755],"Harrisburg, PA":[40.265,-76.885],"Wilmington, DE":[39.746,-75.547],
...
function USMap({athletes, onAthleteClick, selectedAthlete, highlightCollege, highlightHometown, mapMode, selectedStates}) {
  ...
  useEffect(() => {
    ...
    g.selectAll("path.state").data(geo.features).join("path")
      ...
      .attr("stroke",d=>{
        if(mapMode==="heatmap") return "rgba(100,90,85,0.3)";
        const abbr=FIPS_ABBR[String(d.id).padStart(2,"0")];
        return hasStateFilter&&selectedStates.includes(abbr)?T.orange:"#CCCFDD";
      })
      .attr("stroke-width",d=>{
        if(mapMode==="heatmap") return 0.5;
        const abbr=FIPS_ABBR[String(d.id).padStart(2,"0")];
    ...
    if (mapMode === "flows") {
      ...
      active.forEach(a=>{
        ...
        g.append("path").attr("d",arc).attr("fill","none")
          ...
          .attr("stroke-width",isSel?2.5:arcW)
          .attr("stroke-opacity",isSel?1:arcOp)
          ...
          .on("mouseout",function(){d3.select(this).attr("stroke-width",isSel?2.5:arcW).attr("stroke-opacity",isSel?1:arcOp);setTooltip(null);})
    ...
    <div style={{padding:"14px",height:"100%",overflowY:"auto"}}>
      ...
      <div style={{background:T.bgCard,border:`1px solid ${T.border}`,borderRadius:8,padding:"10px 12px",marginBottom:14}}>
        ...
        <div style={{display:"flex",height:10,borderRadius:4,overflow:"hidden",marginBottom:5}}>
          <div style={{flex:1,background:"linear-gradient(to right,#FFF8F4,#F4BF9C,#C85C35,#880202)",borderRadius:4}}/>
        </div>
